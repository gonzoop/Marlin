...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  24.7,  22.20 }
    #define DEFAULT_Ki_LIST {   2.05,   1.08 }
    #define DEFAULT_Kd_LIST { 74.20, 114.00 }
  #else
    #define DEFAULT_Kp  24.70
    #define DEFAULT_Ki   2.05
    #define DEFAULT_Kd 74.2
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 271.36
  #define DEFAULT_bedKi 47.52
  #define DEFAULT_bedKd 1033.07
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 404.90 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -51, -12, -1.75 }
